...
public static class DbSeeder
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        if (tablesExist)
        {
            // نجمع فحوصات/تحديثات الـschema في round-trip واحدة بدل عدة اتصالات
            // عند كل cold start، مع الحفاظ على نفس السلوك idempotent.
            await db.Database.ExecuteSqlRawAsync(@"
...
CREATE INDEX IF NOT EXISTS ""IX_ExamResults_UserId""
    ON ""ExamResults"" (""UserId"");
