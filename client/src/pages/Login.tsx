  ...
  return <div className="login-v2" dir="rtl">
    ...
    <main className="login-v2-wrap">
      <section className="login-v2-showcase">
        ...
        <div className="login-v2-features"><div><b>01</b><span><strong>أسئلة واقعية</strong><small>صور وإشارات مرورية واضحة</small></span></div><div><b>02</b><span><strong>اختبارات محاكاة</strong><small>اختبر نفسك بوقت محدد</small></span></div><div><b>03</b><span><strong>مراجعة الأخطاء</strong><small>اعرف أين أخطأت بعد الاختبار</small></span></div></div>
      </section>
      <section className="login-v2-panel">
        ...
        <form onSubmit={handleSubmit} className="login-v2-form">
          <label>اسم المستخدم<input value={userName} onChange={e=>setUserName(e.target.value)} required autoFocus placeholder="مثال: ahmad2026" autoComplete="username" autoCapitalize="none" spellCheck={false}/></label>
          ...
          <button type="submit" disabled={busy} className="login-v2-submit">{busy?'جارِ التحقق...':'دخول الحساب'}<span>←</span></button>
        </form>
