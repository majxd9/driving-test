 ...
 return <div className="min-h-screen home-page" dir="rtl">
  ...
  <main className="max-w-6xl mx-auto px-5 pb-12">
   <section className="home-hero">
    ...
    <div><div className="home-greeting"><span className="student-name-plate" aria-label="اسم الطالب"><span className="student-name-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="7.5"></circle><circle cx="12" cy="12" r="2.5"></circle><path d="M12 4.5v5M19.5 12h-5M12 19.5v-5M4.5 12h5"></path></svg></span><strong>{firstName || 'طالبنا'}</strong><span className="student-name-glow" aria-hidden="true"></span></span></div><h1>تدرّب جيداً، راجع أخطاءك، وادخل الاختبار بثقة.</h1><p>اختر القسم الذي تريد مراجعته أو انتقل مباشرة إلى محاكاة اختبار الرخصة. الأسئلة والصور والنتائج مرتبة لتكون المراجعة أسرع وأوضح.</p><div className="flex flex-wrap gap-3 mt-6"><button onClick={()=>navigate('/study/Ser')} className="primary-cta">ابدأ التدريب <Icon type="arrow"/></button><SiteGuide/></div></div>
