 ...
 return <div className="min-h-screen home-page" dir="rtl">
  ...
  <main className="max-w-6xl mx-auto px-5 pb-12">
   <section className="home-hero">
    ...
    <div><div className="home-greeting"><span className="student-name-plate"><span className="plate-body"><span className="plate-country" aria-hidden="true"><span className="plate-flag"></span><small>SY</small></span><strong>{firstName || 'طالبنا'}</strong><span className="plate-dot" aria-hidden="true"></span></span></span></div><h1>تدرّب جيداً، راجع أخطاءك، وادخل الاختبار بثقة.</h1><p>اختر القسم الذي تريد مراجعته أو انتقل مباشرة إلى محاكاة اختبار الرخصة. الأسئلة والصور والنتائج مرتبة لتكون المراجعة أسرع وأوضح.</p><div className="flex flex-wrap gap-3 mt-6"><button onClick={()=>navigate('/study/Ser')} className="primary-cta">ابدأ التدريب <Icon type="arrow"/></button><SiteGuide/></div></div>
