...
export default function Exam() {
  ...
  return <div className="exam-page-v2" dir="rtl">
    <header className="exam-topbar-v2"><button onClick={()=>navigate('/models')} className="exam-back-v2" aria-label="العودة">‹</button><div className="exam-title-v2"><strong>اختبار القيادة</strong><span>اختبر نفسك بهدوء</span></div><div className={`exam-timer-v2 ${seconds<=60?'urgent':''}`}>{mm}:{ss}</div></header>
    ...
    <main className="exam-stage-v2"><section className="exam-card-v2">
      <div className="exam-card-topline"><span>السؤال</span></div>
